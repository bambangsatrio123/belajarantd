...
import { DashboardOutlined, FundProjectionScreenOutlined, PartitionOutlined, SettingOutlined, TeamOutlined } from "@ant-design/icons";
import "../App.less";
...
export default function SiderMenu({ handleOnCollapse, collapsed }) {
  ...
  return (
    <Sider breakpoint="lg" collapsedWidth="80" onCollapse={handleOnCollapse} collapsed={collapsed} width="256" theme={theme}>
      <a>
